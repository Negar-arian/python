...
while run:
    ...
    pygame.draw.rect(screen,(255,0,0),(bar1x,bar1y,5,70),0)
    pygame.draw.rect(screen,(0,0,255),(bar2x,bar2y,5,50),0)
    ...
    if bar1y>=420:
      ...
      bar1y=10
    if circlex<=bar1x+10:
      if circley>=bar1y-7.5 and circley<=bar1y+63:
        speedx=-speedx
        circlex=20
      
    if circlex>=bar2x-15:
      if circley>=bar2y-7.5 and circley<=bar2y+43:
        speedx=-speedx
        circlex=605
